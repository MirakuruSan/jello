...
glass and gets out of your way, uses global hotkeys and shortcuts to summon and navigate quickly. It has Zero telemetry, zero bloat, no nonsense, built for privacy. Jello have built-in seach from screenshot and can exract text from them as well using ocr capture. Chrome extensions are supported.
