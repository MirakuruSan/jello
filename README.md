...
glass and gets out of your way, uses global hotkeys and shortcuts to summon and 
navigate quickly. It has Zero telemetry, zero bloat, no nonsense, built for privacy.
Jello have built-in seach from screenshot and can exract text from them as well
using ocr capture. Chrome extensions are supported. This is not designed to be 
the default browser, it is supposed to be a fast research tool.

I mainly built this for my own use, I wanted something lightweight that I can 
summon instantly using a hotkey from anywhere everytime I wanted to look up 
or research something. I was annoyed by the time it took to launch other browsers.
